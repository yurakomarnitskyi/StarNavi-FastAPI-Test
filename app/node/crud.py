...
def update_node(db: Session, node_id: int, updated_node: schemas.NodeUpdate):
...
def process_start_node(db: Session, name: str, description: str, workflow_id: int):
...
def create_message_node(db: Session, name: str, description: str, workflow_id: int, 
                        text: str, status: str):
...
def process_condition_node(db: Session, workflow_id: int):
...
def create_end_node(db: Session, name: str, description: str, workflow_id: int):
    """End node method."""
...
def run_workflow(db: Session, workflow_id: int) -> schemas.WorkflowPath:
